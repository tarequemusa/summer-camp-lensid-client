...
const StudentHome = () => {
    ...
    return (
        <div className="w-full px-10 my-8">
            <Helmet>
                <title>Student Home | LensID An Institute of Photography Since 2020</title>
            </Helmet>
            <div className="w-full">
                <SectionTitle
                    subHeading="Welocme to Student Home"
                    heading="Student Dashboard"
                ></SectionTitle>
            </div>
            <div className="card card-side card-actions justify-center items-center bg-base-100 shadow-xl py-12">
                <figure><img className="w-[50%] rounded-xl" src={user?.photoURL} alt="Movie" /></figure>
